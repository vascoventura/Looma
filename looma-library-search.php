...
looma_trace_page('library-search', [
    'q'        => $_REQUEST['search-term'] ?? $_GET['q'] ?? null,
    'grade'    => $_REQUEST['class']       ?? null,
    'subject'  => $_REQUEST['subj']        ?? null,
    'chapter'  => $_REQUEST['chapter']     ?? null,
    'language' => $_REQUEST['chapter-language'] ?? null,
