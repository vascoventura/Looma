...
<link rel="stylesheet" href="css/looma-map.css?v=<?php echo filemtime('css/looma-map.css'); ?>" />
...
<script src="js/looma-map.js?v=<?php echo filemtime('js/looma-map.js'); ?>"></script>
