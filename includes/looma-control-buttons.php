    ...
    <!--
        - include this file in PHP to add LOOMA CONTROL BUTTONS (speak, looma-assistant, lookup, captions, keyboard, fullscreen)
    ...
    <button class="show-keyboard looma-control-button">
        <?php tooltip("Keyboard") ?>
    </button>
    ...
    <?php
        // LOOMA Assistant chat modal — kept next to the buttons (inside #fullscreen)
        // so the assistant works in fullscreen mode just like Speak/Lookup.
        include_once('includes/looma-assistant-modal.php');
    ?>
