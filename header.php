...
// OpenTelemetry — dependency-free shim that posts one span per request
// to the otel-collector via OTLP/HTTP. Registered as a shutdown hook so
// it never delays the page response.
@include_once __DIR__ . '/includes/otel.php';
